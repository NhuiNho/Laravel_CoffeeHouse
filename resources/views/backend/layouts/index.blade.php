                    ...
                    <div class="card card-table">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="user-avatar"> <img src="{{ asset('storage\backend\assets\img\avatar6.png') }}"
                                                alt="Avatar">Penelope Thornton</td>
                                    ...
                                    <tr>
                                        <td class="user-avatar"> <img src="{{ asset('storage\backend\assets\img\avatar4.png') }}"
                                                alt="Avatar">Benji Harper</td>
                                    ...
                                    <tr>
                                        <td class="user-avatar"> <img src="{{ asset('storage\backend\assets\img\avatar5.png') }}"
                                                alt="Avatar">Justine Myranda</td>
                                    ...
                                    <tr>
                                        <td class="user-avatar"> <img src="{{ asset('storage\backend\assets\img\avatar3.png') }}"
                                                alt="Avatar">Sherwood Clifford</td>
