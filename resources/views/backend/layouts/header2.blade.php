                ...
                <div class="tab-content">
                    <div class="tab-pane tab-chat active" id="tab1" role="tabpanel">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="contact-list contact-list-recent">
                                            <div class="user"><a href="#"><img
                                                        src="{{ asset('storage\backend\assets\img\avatar1.png') }}" alt="Avatar">
                                            ...
                                            <div class="user"><a href="#"><img
                                                        src="{{ asset('storage\backend\assets\img\avatar2.png') }}" alt="Avatar">
                                            ...
                                            <div class="user"><a href="#"><img
                                                        src="{{ asset('storage\backend\assets\img\avatar3.png') }}" alt="Avatar">
                                        ...
                                        <div class="contact-list">
                                            <div class="user"><a href="#"><img
                                                        src="{{ asset('storage\backend\assets\img\avatar4.png') }}" alt="Avatar">
                                                    <div class="user-data2"><span class="status"></span><span
                                                            class="name">Mike Bolthort</span></div>
                                                </a></div>
                                            <div class="user"><a href="#"><img
                                                        src="{{ asset('storage\backend\assets\img\avatar5.png') }}" alt="Avatar">
                                                    <div class="user-data2"><span class="status"></span><span
                                                            class="name">Maggie jackson</span></div>
                                                </a></div>
                                            <div class="user"><a href="#"><img
                                                        src="{{ asset('storage\backend\assets\img\avatar6.png') }}" alt="Avatar">
                        ...
                        <div class="chat-window">
                            <div class="title">
                                <div class="user"><img src="{{ asset('storage\backend\assets\img\avatar2.png') }}" alt="Avatar">
