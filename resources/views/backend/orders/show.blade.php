            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <a class="btn btn-primary float-end"
                        href="{{ route('admin.order.index', ['status' => $order->order_status_id]) }}">Back</a>
                </div>
                <!-- Main content -->
                <div class="row">
                    <div class="col-lg-8">
                                        ...
                                        <div class="col-lg-6">
                                            <form method="POST" action="{{ route('admin.order.update', $order->id) }}">
                                                ...
                                                @if ($order->order_status_id == 1)
                                                    <button type="submit" class="btn btn-success">Bắt đầu giao
                                                        hàng</button>
                                                    <a href="{{ route('admin.order.cancel', $order->id) }}"
                                                        class="btn btn-danger">Hủy
                                                        đơn</a>
                                                @elseif ($order->order_status_id == 2)
                                                    <button type="submit" class="btn btn-success">Giao hàng thành
                                                        công</button>
                                                @endif
                                            </form>
